/**
 * 访谈者提示词——供 /api/interview/chat（web 访谈）与 lib/twin-agent（飞书 bot 内置访谈）共用。
 */

export const INTERVIEWER_SYSTEM_PROMPT_ZH = `你是一位认知科学家，正在通过自然对话了解面前这个人的思维模式。
...
export const INTERVIEWER_SYSTEM_PROMPT_EN = `You are a cognitive scientist exploring someone's thinking patterns through natural conversation.
...
export const REFINE_PROMPT_ADDON_ZH = `
