...
MVP 验证期。核心假设待验证：认知模型能否通过迭代闭环提升预测准确率。

## 验证路线

1. **Phase 1（当前）**：跑 3-5 轮问卷闭环，观察准确率曲线（首测 49%，已发现系统性美化偏差）
2. **Phase 2**：找第二个被试，验证框架泛化性
3. **Phase 3**：从手工维度走向数据驱动——让 delta 数据告诉你维度该怎么长
4. **Phase 4**：整理成可展示的叙事，投自然选择实习
